...
static const char webBodyRootConsole[] PROGMEM =
  ...
  "  <input type=\"text\" id=\"logSearch\" placeholder=\"Search log...\" style=\"width:200px;\">"
  "  <button onclick=\"copyLog()\">Copy</button>"
  "  <button onclick=\"clearLog()\">Clear</button>"
  "</div>"
  "<textarea id=\"cli\" disabled style=\"height:60vh;width:98%;overflow-y:auto;font-family:monospace;resize:vertical;\"></textarea><br />"
  "<input type=\"checkbox\" id=\"autoscroll\" checked=\"checked\">Enable autoscroll"
  "<script>"
  "document.getElementById('logSearch').addEventListener('input', function() {"
  "  var filter = this.value.toLowerCase();"
  "  var lines = window.cliFullLog ? window.cliFullLog.split('\\n') : document.getElementById('cli').value.split('\\n');"
  "  var filtered = lines.filter(function(line){return line.toLowerCase().indexOf(filter) !== -1;});"
  "  document.getElementById('cli').value = filtered.join('\\n');"
  "});"
  "function copyLog() {"
  "  var log = document.getElementById('cli').value;"
  ...
  "}"
  "window.cliFullLog = '';"
  "var cliElem = document.getElementById('cli');"
  "var origSetValue = Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype, 'value').set;"
  "Object.defineProperty(cliElem, 'value', {"
  "  set: function(val) {"
  "    window.cliFullLog = val;"
  "    origSetValue.call(this, val);"
  "  },"
  "  get: function() { return origSetValue.call(this); }"
  "});"
  "</script>"
  "</div>";
